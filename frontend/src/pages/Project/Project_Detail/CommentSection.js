...
const CommentSection = ({ projectId }) => {
  ...
  const handlePostComment = async () => {
    if (isAdmin || commentContent.trim() === "") return;
    ...
    <div className={styles.commentSectionWrapper}>
      ...
      <div className={styles.allComments}>
        {commentState?.comments?.comments?.length > 0 ? (
                ...
                <div>
                  ...
                  <div className={styles.singleComment_info}>
                    <div className={styles.singleComment_header}>
                      ...
                      {(comment?.userId?._id === userId || isAdmin) && (
                        <div>
                          <svg
                    ...
                    <div className={styles.singleComment_footer}>
                      <div>
                        ...
                        <div>
                          {!isAdmin && comment?.likeBy?.includes(userId) ? (
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                              fill="currentColor"
                    ...
                    <div>
                      {!isAdmin && replyInputVisible[comment._id] && (
                    ...
                    {getReplies(comment._id).length > 0 && (
                      ...
                      >
                        ...
                        <span>{getReplies(comment._id).length} replies</span>
                      </p>
                    )}
                          ...
                          <div key={reply._id} className={styles.replyComment}>
                            ...
                            <div className={styles.singleComment_info}>
                              <div className={styles.singleComment_header}>
                                ...
                                {(reply?.userId?._id === userId || isAdmin) && (
                                  <div>
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      viewBox="0 0 16 16"
          ...
          <div>{!isAdmin && <p>No comments yet. Be the first one!</p>}</div>
        )}
      </div>
    </div>
  );
